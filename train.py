...
class ViTASDLM(LightningModule):
    def __init__(self,
        ...
        self.auroc = AUROC(num_classes=2, task='multiclass')
        self.confusion_matrix = ConfusionMatrix(num_classes=self.hparams.num_classes, normalize='true',task='multiclass')
